---
title: Start Sandbox
description: Start a stopped or archived sandbox
api: POST /sandbox/{sandboxIdOrName}/start
---
...
<ResponseField name="state" type="string">
  The current state of the sandbox (will be `starting` or `restoring`)
  
  **Options:** `starting`, `restoring`, `started`
</ResponseField>
...
```bash cURL with Name
curl -X POST https://api.daytona.io/sandbox/my-development-sandbox/start \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "X-Daytona-Organization-ID: your-org-id"
```
